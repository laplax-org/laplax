...
## `context_points.py`
This module provides a collection of context points generators for [FSP-Laplaces](references/fsp.md) context points. 


## `objective.py`
This module provides the loss function and regularizer which is needed for [FSP-Laplaces](references/fsp.md).